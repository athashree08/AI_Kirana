          ...
          <div className="bg-white border border-[#E5E7EB] rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
            ...
            <div className="flex justify-between items-start">
              <div>
                ...
                <h3 className="text-sm font-black text-[#002970] mt-2">{kpis.statusLabel}</h3>
              </div>
            ...
            <div className="bg-[#F8F9FB] p-1 rounded-2xl flex text-xs font-black text-[#6B7280] h-[44px] items-center border border-[#E5E7EB]">
              <button
                ...
                className={`flex-grow h-full py-2 rounded-xl text-center cursor-pointer transition-all flex items-center justify-center gap-2 ${
                  activeTab === "all" ? "bg-white text-[#002970] shadow-sm border border-[#E5E7EB]/50" : "hover:text-[#002970]"
                }`}
              >
              ...
              <button
                ...
                className={`flex-grow h-full py-2 rounded-xl text-center cursor-pointer transition-all flex items-center justify-center gap-2 ${
                  activeTab === "in" ? "bg-white text-[#00C853] shadow-sm border border-[#E5E7EB]/50" : "hover:text-[#002970]"
                }`}
              >
              ...
              <button
                ...
                className={`flex-grow h-full py-2 rounded-xl text-center cursor-pointer transition-all flex items-center justify-center gap-2 ${
                  activeTab === "out" ? "bg-white text-[#D32F2F] shadow-sm border border-[#E5E7EB]/50" : "hover:text-[#002970]"
                }`}
              >
          ...
          <div className="flex-1 overflow-y-auto divide-y divide-[#E5E7EB] bg-[#F8F9FB]">
            {filteredList.length > 0 ? (
                  ...
                  >
                    <div className="flex items-center gap-3.5 min-w-0">
                      ...
                      <div className="min-w-0">
                        <h4 className="text-xs font-extrabold text-[#002970] truncate">{rec.description}</h4>
              ...
              <div className="py-20 flex flex-col items-center justify-center text-center p-6 bg-white h-full">
                ...
                <h4 className="text-xs font-extrabold text-[#002970]">No cash entries matching filter</h4>
        ...
        <div className="w-[450px] flex flex-col min-h-0 bg-white border border-[#E5E7EB] rounded-3xl overflow-y-auto shadow-sm">
          {selectedRecord ? (
            <div className="flex-grow flex flex-col justify-between min-h-0">
              ...
              <div className="p-5 border-b border-[#E5E7EB] shrink-0">
                ...
                <div className="flex items-center gap-4 mt-4">
                  ...
                  <div>
                    <h3 className="text-sm font-black text-[#002970] leading-snug">{selectedRecord.description}</h3>
                ...
                <div className="grid grid-cols-3 gap-3.5 mt-5 bg-[#F8F9FB] border border-[#E5E7EB] rounded-2xl p-3.5">
                  <div>
                    ...
                    <span className="text-[10px] font-extrabold text-[#002970] block mt-0.5 truncate">{selectedRecord.category}</span>
                  </div>
                  <div>
                    <span className="text-[8px] font-extrabold uppercase text-[#6B7280] tracking-wider block">Drawer Amount</span>
                    <span className="text-[10px] font-black text-[#002970] block mt-0.5">₹{selectedRecord.amount.toLocaleString("en-IN")}</span>
                  </div>
                  <div>
              ...
              {aiDiagnostics && (
                <div className="p-5 border-b border-[#E5E7EB] bg-gradient-to-tr from-sky-50/20 to-indigo-50/20 shrink-0">
                  <span className="text-[9px] font-extrabold uppercase tracking-wider text-[#00BAF2] flex items-center gap-1 mb-2.5">
                    <Sparkles className="w-3.5 h-3.5 text-[#00BAF2]" /> AI Cash Diagnostics
                  </span>
                ...
                <div className="bg-white border border-[#E5E7EB] rounded-3xl p-4 shadow-sm space-y-3.5">
                  <div className="flex items-center justify-between gap-4">
                    <div>
                      ...
                      <h4 className="text-sm font-black text-[#002970] mt-0.5">₹{kpis.cashInHand.toLocaleString("en-IN")}</h4>
                    </div>
                    ...
                    <div className="flex justify-between text-[8px] font-extrabold text-[#6B7280] mt-2.5 px-0.5 border-t border-[#E5E7EB] pt-2">
                      {chartData.days.map((lbl, idx) => (
                        <div key={idx} className="flex flex-col items-center">
                          ...
                          <span className="text-[7px] text-[#002970] mt-0.5">₹{(chartData.balances[idx] / 1000).toFixed(1)}k</span>
                        </div>
                      ))}
                    </div>
                  </div>
            ...
            <div className="flex-1 flex flex-col justify-center text-center p-6 bg-white min-h-[400px]">
              ...
              <h3 className="text-xs font-black text-[#002970]">Liquidity Analytics Workspace</h3>
        ...
        {showAddModal && (
          <div className="fixed inset-0 bg-[#081A38]/60 backdrop-blur-sm z-[100] flex items-center justify-center p-4">
            ...
            >
              ...
              <h3 className="text-base font-black text-[#002970] mb-2">{isEditing ? "Edit" : "Record"} Cash Entry</h3>
              ...
              <form onSubmit={handleFormSubmit} className="space-y-4">
                  ...
                  <div className="bg-[#EEF3F7] p-1 rounded-xl flex text-[10px] font-extrabold text-[#6B7280] h-[40px] items-center">
                    <button
                      ...
                      className={`flex-grow py-1.5 rounded-lg text-center cursor-pointer transition-all ${
                        formFlowType === "in" ? "bg-white text-[#00C853] shadow-sm" : "hover:text-[#002970] disabled:opacity-40"
                      }`}
                    >
                      Cash-In (Receipt)
                    </button>
                    <button
                      ...
                      className={`flex-grow py-1.5 rounded-lg text-center cursor-pointer transition-all ${
                        formFlowType === "out" ? "bg-white text-[#D32F2F] shadow-sm" : "hover:text-[#002970] disabled:opacity-40"
                      }`}
                    >
                      Cash-Out (Payout)
                    </button>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    rows={2}
                    className="w-full bg-[#F8F9FB] border border-[#E5E7EB] rounded-xl px-4 py-2.5 text-xs font-semibold outline-none focus:border-[#00BAF2] text-[#111827] resize-none"
                  />
                </div>
